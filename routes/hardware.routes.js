...
router.post('/bypass/onoff', [verifyToken, routeAccessMiddleware(), logMiddleware('info', 'info-write-bypass-optimizers')], HardwareController.BypassOnOff);
router.post('/bypass/delete', [verifyToken, routeAccessMiddleware(), logMiddleware('info', 'info-write-bypass-optimizers')], HardwareController.BypassDelete);
