...
// enterprise list
router.get('/get/enterprise/list/:flag', [verifyToken, logMiddleware('info', 'info-read-enterpriselist')], EnterpriseController.EnterpriseListData); // flag should be "data"/"name"
